...
import { BrandLogo } from "@/components/DynamicBranding";
  ...
  return (
    <>
      ...
      <div className="mobile-nav-container md:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-neutral-200 shadow-sm">
        ...
        {isOpen && (
          <div className="absolute top-full left-0 right-0 bg-white border-b border-neutral-200 shadow-lg z-[1000] overflow-x-hidden">
            <div className="px-4 py-4 space-y-2 max-h-screen overflow-y-auto overflow-x-hidden">
              {menuItems.map((item) => (
                <Button
                  key={item.path}
                  variant="ghost"
      ...
      <div className="hidden md:flex fixed left-0 top-0 h-full w-64 bg-white border-r border-neutral-200 flex-col z-40 overflow-x-hidden">
